          ...
          <div class="tab-content" id="pills-tabContent">
              ...
              >
                ...
                <h6 class="mb-3">
                  ...
                  <span class="badge badge-success"
                    ><i class="icofont-tags"></i> 15% Off All Items
                  </span>
                </h6>
                <div
                  class="
                    owl-carousel owl-theme owl-carousel-five
                    offers-interested-carousel
                    mb-3
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                  ...
                  >
                    <div class="list-card-image">
                      ...
                      <div
                        class="favourite-heart text-danger position-absolute"
                      >
                  ...
                  <div class="bg-white rounded border shadow-sm mb-4">
                    ...
                    <div class="gold-members p-3">
                      ...
                      <div class="media">
                        <div class="mr-3">
                          <i
                            class="icofont-ui-press text-success food-item"
                          ></i>
                        </div>
                        <div class="media-body">
                          <h6 class="mb-1">
            ...
            >
              ...
              >
                ...
                <p class="mb-3">
                  Jagjit Nagar, Near Railway Crossing, <br />
                  Near Model Town, Ludhiana, PUNJAB
                </p>
                ...
                <div class="border-btn-main mb-4">
                  <a class="border-btn text-success mr-2" href="#"
                    ><i class="icofont-check-circled"></i> Breakfast</a
                  >
                  <a class="border-btn text-danger mr-2" href="#"
                    ><i class="icofont-close-circled"></i> No Alcohol
                    Available</a
                  >
                  <a class="border-btn text-success mr-2" href="#"
                    ><i class="icofont-check-circled"></i> Vegetarian Only</a
                  >
                  <a class="border-btn text-success mr-2" href="#"
                    ><i class="icofont-check-circled"></i> Indoor Seating</a
                  >
                  <a class="border-btn text-success mr-2" href="#"
                    ><i class="icofont-check-circled"></i> Breakfast</a
                  >
            ...
            >
              ...
              >
                ...
                <div class="reviews-members pt-4 pb-4">
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <div class="reviews-members-footer">
                        <a class="total-like" href="#"
                          ><i class="icofont-thumbs-up"></i> 88K</a
                        >
                        <a class="total-like" href="#"
                          ><i class="icofont-thumbs-down"></i> 1K</a
                        >
                        <span class="total-like-user-main ml-2" dir="rtl">
                          <a
                            data-toggle="tooltip"
                ...
                <hr />
                <a
                  class="text-center w-100 d-block mt-4 font-weight-bold"
                  href="#"
                  >See All Reviews</a
                >
              </div>
